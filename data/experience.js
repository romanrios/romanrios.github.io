...
export const experience = {
  academic: [
    ...
    {
      title: {
        es: "Universidad Nacional del Litoral",
      ...
      description: {
        ...
        en: "Bachelor’s Degree in Visual Communication Design · Facultad de Arquitectura, Diseño y Urbanismo",
      },
  ...
  work: [
    {
      title: {
        es: "Ministerio de Trabajo, Empleo y Seguridad Social de la Provincia de Santa Fe",
  ...
  courses: [
    ...
    {
      title: {
        es: "Argentina Programa 4.0",
        en: "Argentina Programa 4.0",
      },
