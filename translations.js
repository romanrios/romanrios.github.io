export const elements_innerHTML = {
  hero_subtitle: {
    en: "Software Developer /<br/>Visual Designer",
    es: "Desarrollador de Software /<br/>Diseñador de Comunicación Visual",
  },
  hero2_text: {
    en: "Software Developer and Visual Communication Designer, with a focus on web development and multimedia design.<br><br>I have a university background in Visual Communication Design (FADU–UNL) and I am currently in the final stage of a Higher Technical Degree in Software Development.<br><br>I work at the Press Office of the Ministry of Labor, Employment and Social Security of the Province of Santa Fe, where I develop graphic, digital, and audiovisual communication materials for institutional projects.<br><br>I define myself as a proactive, adaptable, and team-oriented professional, with a strong interest in continuous learning and in adding value to every project.",
    es: "Desarrollador de software y diseñador de comunicación visual, con foco en desarrollo web y diseño multimedia.<br><br>Formación universitaria en Diseño de Comunicación Visual (FADU–UNL) y actualmente en etapa final de la Tecnicatura Superior en Desarrollo de Software.<br><br>Trabajo en la Oficina de Prensa del Ministerio de Trabajo, Empleo y Seguridad Social de la Provincia de Santa Fe, donde desarrollo contenidos y piezas de comunicación gráfica, digital y audiovisual para proyectos institucionales.<br><br>Me defino como una persona proactiva, adaptable y orientada al trabajo en equipo, con interés en el aprendizaje continuo y en aportar valor a cada proyecto.",
  },
  nav_inicio: {
    en: "Home",
    es: "Inicio",
  ...
  exp_motion_title: {
    en: "Postgraduate course FADU UNL",
    es: "Curso de Posgrado FADU UNL",
  },
  exp_motion: {
  ...
  exp_fusa: {
    en: "Freelance multimedia design.",
  ...
  exp_seal: {
    ...
    es: "Administración y facturación en la industria de productos plásticos.",
  },
  exp_zona: {
    en: "Sales and technical service of video games and computing.",
  ...
  hab_diseñowebyapps: {
    en: "Web design & Apps",
    es: "Diseño web y Apps",
  },
  hab_interfazdeusuario: {
    en: "User interface",
    es: "Interfaz de usuario",
  },
  hab_diseñodeinformacion: {
  ...
  hab_vst: {
    ...
    es: "Instrumentos virtuales VST",
  },
  proyecto_schokoladenbar: {
    en: "Casual web video game",
    es: "Videojuego web casual",
  },
  proyecto_pino: {
    en: "Platform game",
  ...
  proyecto_rockquiz: {
    en: "Music, puzzle & quiz game",
    es: "Videojuego de música, puzzle y quiz",
  },
  proyecto_spacewars: {
    en: "Shoot'em up game",
    es: "Videojuego shoot'em up",
  },
  proyecto_mostrimaker: {
    en: "Global Game Jam 2024 game",
    es: "Juego para la Global Game Jam 2024",
  },
  proyecto_futumag: {
    en: "Digital magazine about design and technology",
  ...
  proyecto_bienal: {
    en: "Animation and original music",
    es: "Animación y música original",
  },
  // proyecto_weather: {
  //     en:"Website to check the weather",
  //     es:"Sitio web para consultar el clima"
  // },
  masDesarrollo: {
    en: "Development projects on GitHub",
    es: "Proyectos de Desarrollo en GitHub",
  },
  masDiseño: {
    en: "Design projects on Behance",
    es: "Proyectos de Diseño en Behance",
  },
  certificates: {
    en: "📄 Certificates PDF",
    es: "📄 Certificados PDF",
...
export const elements_placeholder = {
  form_nombre: {
    en: "Name",
    es: "Nombre",
  },
